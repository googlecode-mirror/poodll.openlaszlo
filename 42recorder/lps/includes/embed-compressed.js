...
Lz[$1.id]={runtime:"swf",_id:$1.id,setCanvasAttribute:Lz._setCanvasAttributeSWF,getCanvasAttribute:Lz._getCanvasAttributeSWF,callMethod:Lz._callMethodSWF,_loaded:Lz._loaded,_setCanvasAttributeDequeue:Lz._setCanvasAttributeDequeue}
...
Lz[$1.id]={runtime:"dhtml",_id:$1.id,setCanvasAttribute:Lz._setCanvasAttributeDHTML,getCanvasAttribute:Lz._getCanvasAttributeDHTML}
if(!Lz["setCanvasAttribute"]){
Lz.setCanvasAttribute=Lz[$1.id].setCanvasAttribute
}
if(!Lz["getCanvasAttribute"]){
...
$2.setAttribute("type","text/javascript")
$2.setAttribute("src",$1)
